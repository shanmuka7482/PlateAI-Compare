...
>(function FileUploadDropzone(props, ref) {
  ...
  return (
    <ChakraFileUpload.Dropzone ref={ref} {...rest} borderColor={"indigo.400"} bg={"neutral.800"}>
      <Icon fontSize="6xl" color="indigo.500">
      <LuCloudUpload />
      </Icon>
      <ChakraFileUpload.DropzoneContent>
        <div style={{ fontFamily: "heading" }}>{label}</div>
        {description && <Text color="fg.muted" fontFamily={"heading"}>{description}</Text>}
      </ChakraFileUpload.DropzoneContent>
      {children}
